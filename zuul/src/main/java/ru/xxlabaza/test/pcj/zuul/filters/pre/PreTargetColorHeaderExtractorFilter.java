 ...
 */
@Component
public class PreTargetColorHeaderExtractorFilter extends AbstractZuulFilter {

  public final static String TARGET_COLOR_KEY = "targetColor";
  ...
  public boolean shouldFilter () {
    val targetColorHeaderName = appProperties.getZuul().getTargetColorHeaderName();
    return RequestContext.getCurrentContext()
        .getRequest()
        .getHeader(targetColorHeaderName) != null;
  }
  ...
  protected void execute () {
    ...
    val targetColorHeaderName = appProperties.getZuul().getTargetColorHeaderName();
    val value = currentContext.getRequest().getHeader(targetColorHeaderName);
    currentContext.set(TARGET_COLOR_KEY, value);
  }
}
